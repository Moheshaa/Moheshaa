...
function love.load()
    ...
    sounds = {
        ...
        ['Swinging_Sweet']=love.audio.newSource('sounds/Swinging_Sweet.ogg', 'static')
    }
...
function love.update(dt)
    --bgmusic
    sounds['Swinging_Sweet']:setLooping(true)
    sounds['Swinging_Sweet']:play()
    ...
    --player 2 movement not required here as the paddle is going to run automatically using Computer function
    -- -- player 2 movement 
    ...
    player1:update(dt)
    --the AI paddle is only going to move when the ball crosses the middle line and moves towards the AI paddle. The virtual width is 432. Therefore the halfway mark will be 216. hence the computer paddle will move only when the ball crosses the halfway mark
    if ball.x>216 then
        player2:Computer(ball)
    end
